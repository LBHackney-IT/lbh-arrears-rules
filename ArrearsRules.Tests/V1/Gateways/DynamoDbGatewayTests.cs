...
using AutoFixture;
using ArrearsRules.Tests.V1.Helper;
using ArrearsRules.V1.Domain;
using ArrearsRules.V1.Gateways;
using ArrearsRules.V1.Infrastructure;
...
namespace ArrearsRules.Tests.V1.Gateways
{
    //TODO: Remove this file if DynamoDb gateway not being used
    //TODO: Rename Tests to match gateway name
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-lbh-arrears-rules/wiki/Running-the-test-suite.
    [TestFixture]
