...
using ArrearsRules.V1.UseCase;
using Hackney.Core.Testing.Shared;
using Moq;
using NUnit.Framework;

namespace ArrearsRules.Tests.V1.UseCase
{
    public class GetByIdUseCaseTests : LogCallAspectFixture
    {
        ...
        //Guidance on unit testing and example of mocking can be found here https://github.com/LBHackney-IT/lbh-lbh-arrears-rules/wiki/Writing-Unit-Tests
    }
}
