...
namespace ArrearsRules.V1.Factories
{
    public static class EntityFactory
    {
        public static Entity ToDomain(this DatabaseEntity databaseEntity)
        {
            ...
            // More information on this can be found here https://github.com/LBHackney-IT/lbh-lbh-arrears-rules/wiki/Factory-object-mappings
